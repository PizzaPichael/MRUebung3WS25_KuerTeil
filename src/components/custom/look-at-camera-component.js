...
AFRAME.registerComponent('look-at-camera', {
  ...
  /*
  * Initializes camera references and the initial rotation.
  */
  init: function () {
  ...
  /*
  * Slerps the entity rotation toward a target quaternion.
  */
  ...
  */
  ...
  /*
  * Updates look direction each frame based on state.
  ...
  * 
  * If enabled, the entity looks at the camera/player.
  */
  tick: function () {
